        ...
        <form>
          ...
          >
            ...
            <Grid item xs={12} sm={12} md={12} lg={8} xl={8}>
              <p style={{ color: "grey", fontSize: 25, marginTop: 25 }}>
            ...
            <Grid item xs={12} sm={12} md={12} lg={8} xl={8}>
              <Grid container spacing={2}>
                ...
                <Grid
                  ...
                  sx={{ color: "white", fontSize: 20 }}
                >
                  <label onClick={handleEmail} htmlFor="">
                    Email*
                  </label>
                </Grid>
                <Grid item xs={12} sm={12} md={12} lg={10} xl={10}>
                ...
                <Grid
                  ...
                  sx={{ color: "white", fontSize: 20 }}
                >
                  <label onClick={handleSub} htmlFor="">
                    Subject{" "}
                  </label>
                </Grid>
                <Grid item xs={12} sm={12} md={12} lg={10} xl={10}>
                ...
                <Grid
                  ...
                  lg={2}
                  xl={2}
                  sx={{ color: "white", fontSize: 20, marginTop: 4 }}
                >
                  <label onClick={handleMsg} htmlFor="">
                    Message*{" "}
                  </label>
                </Grid>
                <Grid
